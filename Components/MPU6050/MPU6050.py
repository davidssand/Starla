...
class MPU6050:
    ...
    def showData(self):
        ...
        print("X Rotation: " , self.get_x_rotation(self.acelerometer.x_scaled, self.acelerometer.y_scaled, self.acelerometer.z_scaled))
        print("Y Rotation: " , self.get_y_rotation(self.acelerometer.x_scaled, self.acelerometer.y_scaled, self.acelerometer.z_scaled))
